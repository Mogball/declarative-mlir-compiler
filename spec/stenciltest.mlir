func @laplace(%arg0: !stencil.field<[-1, -1, -1],f64>, %arg1: !stencil.field<[-1, -1, -1],f64>) attributes {stencil.program} {
  ...
  %1 = stencil.apply(%0) : (!stencil.temp<[-1, -1, -1],f64>) -> !stencil.temp<[-1, -1, -1],f64> (%arg2: !stencil.temp<[-1, -1, -1],f64>) {
    ...
    %5 = stencil.access %arg2 [0, -1, 0] : (!stencil.temp<[-1, -1, -1],f64>) -> f64
    %6 = stencil.access %arg2 [0, 0, 0] : (!stencil.temp<[-1, -1, -1],f64>) -> f64
    %7 = addf %2, %3 : f64
    %8 = addf %4, %5 : f64
    %9 = addf %7, %8 : f64
